...
class NoteTest < MiniTest::Spec
  ...
  it "delegates ordered_groups and ordered_note_groups to survey" do
    DatabaseCleaner.cleaning do
      ...
      question = create_survey_question(survey_group: group_0)
      note = create_note(survey_group: group_1)
      create_note(survey_group: group_2)
      assert_equal [group_1, group_2, group_3].to_set, note.ordered_note_groups.to_set
      assert_equal SurveyGroup.all.to_set, note.ordered_groups.to_set
      assert_equal SurveyGroup.all.to_set, question.ordered_groups.to_set
    end
  end
